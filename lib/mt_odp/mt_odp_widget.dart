...
import 'mt_odp_model.dart';
export 'mt_odp_model.dart';

class MtOdpWidget extends StatefulWidget {
  const MtOdpWidget({super.key});

  @override
  State<MtOdpWidget> createState() => _MtOdpWidgetState();
}

class _MtOdpWidgetState extends State<MtOdpWidget> {
  late MtOdpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MtOdpModel());
  }
